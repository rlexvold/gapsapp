!function(modules) {
    ...
    var _react = __webpack_require__(5), _react2 = _interopRequireDefault(_react), _reactRouter = __webpack_require__(44), _reactRouter2 = _interopRequireDefault(_reactRouter), _reactDom = __webpack_require__(148), _reactDom2 = _interopRequireDefault(_reactDom), _createBrowserHistory = __webpack_require__(243), _createBrowserHistory2 = _interopRequireDefault(_createBrowserHistory), _routes = __webpack_require__(236), _routes2 = _interopRequireDefault(_routes), _Navbar = __webpack_require__(229), history = (_interopRequireDefault(_Navbar), 
    (0, _createBrowserHistory2.default)());
    _reactDom2.default.render(_react2.default.createElement(_reactRouter2.default, {
        history: history
    }, _routes2.default), document.getElementById("app"));
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    var _alt = __webpack_require__(115), _alt2 = _interopRequireDefault(_alt), _toastr = __webpack_require__(69);
    _interopRequireDefault(_toastr);
    ...
    (function($) {
        ...
        }(), _alt = __webpack_require__(25), _alt2 = _interopRequireDefault(_alt), AddFoodActions = function() {
            function AddFoodActions() {
                _classCallCheck(this, AddFoodActions), this.generateActions("addFoodSuccess", "addFoodFail", "updateName", "updateCategory", "updatePhase", "invalidName", "invalidCategory", "invalidPhase");
            }
            return _createClass(AddFoodActions, [ {
                key: "addFood",
                value: function(name, category, phase) {
                    var _this = this;
                    $.ajax({
                        type: "POST",
                        url: "/api/food",
    ...
    (function($) {
        ...
        }(), _alt = __webpack_require__(25), _alt2 = _interopRequireDefault(_alt), FoodActions = function() {
            function FoodActions() {
                _classCallCheck(this, FoodActions), this.generateActions("getFoodSuccess", "getFoodFail");
            }
            return _createClass(FoodActions, [ {
                key: "getFood",
                value: function(FoodId) {
                    var _this = this;
                    $.ajax({
                        url: "/api/food/" + FoodId
                    }).done(function(data) {
    ...
    (function($) {
        ...
        }(), _alt = __webpack_require__(25), _alt2 = _interopRequireDefault(_alt), FoodListActions = function() {
            function FoodListActions() {
                _classCallCheck(this, FoodListActions), this.generateActions("getFoodsSuccess", "getFoodsFail");
            }
            return _createClass(FoodListActions, [ {
                key: "getFoods",
                value: function(payload) {
                    var _this = this, queryString = '{"phase":{"$lte":' + payload.phase + "}}", url = "/api/food/query=" + queryString;
                    $.ajax({
                        url: url
                    }).done(function(data) {
    ...
    var _alt = __webpack_require__(25), _alt2 = _interopRequireDefault(_alt), FooterActions = function FooterActions() {
        _classCallCheck(this, FooterActions), this.generateActions();
    };
    ...
    var _alt = __webpack_require__(25), _alt2 = _interopRequireDefault(_alt), HomeActions = function HomeActions() {
        _classCallCheck(this, HomeActions), this.generateActions();
    };
    ...
    (function($) {
        ...
        }(), _alt = __webpack_require__(25), _alt2 = _interopRequireDefault(_alt), _underscore = __webpack_require__(111), NavbarActions = function() {
            function NavbarActions() {
                _classCallCheck(this, NavbarActions), this.generateActions("updateOnlineUsers", "updateAjaxAnimation", "updateSearchQuery", "getFoodCountSuccess", "getFoodCountFail", "findFoodSuccess", "findFoodFail");
            }
            return _createClass(NavbarActions, [ {
                key: "findFood",
                value: function(payload) {
                    var _this = this;
                    $.ajax({
                        ...
                        (0, _underscore.assign)(payload, data), _this.actions.findFoodSuccess(payload);
                    }).fail(function() {
    ...
    (function($) {
        ...
        }(), _react = __webpack_require__(5), _react2 = _interopRequireDefault(_react), _reactRouter = __webpack_require__(44), _NavbarStore = __webpack_require__(242), _NavbarStore2 = _interopRequireDefault(_NavbarStore), _NavbarActions = __webpack_require__(228), _NavbarActions2 = _interopRequireDefault(_NavbarActions), Navbar = function(_React$Component) {
            function Navbar(props) {
                _classCallCheck(this, Navbar);
                var _this = _possibleConstructorReturn(this, (Navbar.__proto__ || Object.getPrototypeOf(Navbar)).call(this, props));
                return _this.state = _NavbarStore2.default.getState(), _this.onChange = _this.onChange.bind(_this), 
                _this;
            }
            return _inherits(Navbar, _React$Component), _createClass(Navbar, [ {
                key: "componentDidMount",
                value: function() {
                    _NavbarStore2.default.listen(this.onChange), _NavbarActions2.default.getFoodCount();
                ...
                value: function(event) {
                    ...
                    searchQuery && _NavbarActions2.default.findFood({
                ...
                value: function() {
                    return _react2.default.createElement("nav", {
                        ...
                        className: "tri invert"
                    })), "LifeTech", _react2.default.createElement("span", {
                        className: "badge badge-up badge-danger"
                    }, this.state.onlineUsers))), _react2.default.createElement("div", {
                        id: "navbar",
                        ...
                        placeholder: this.state.totalFoods + " Foods",
                    ...
                    }, _react2.default.createElement("li", null, _react2.default.createElement(_reactRouter.Link, {
                        to: "/"
                    ...
                    }, "Phase", _react2.default.createElement("span", {
                        className: "caret"
                    })), _react2.default.createElement("ul", {
                        className: "dropdown-menu"
                    }, _react2.default.createElement("li", null, _react2.default.createElement(_reactRouter.Link, {
                        to: "/phase/1"
                    }, "GAPS Phase 1")), _react2.default.createElement("li", null, _react2.default.createElement(_reactRouter.Link, {
                        to: "/phase/2"
                    }, "GAPS Phase 2")), _react2.default.createElement("li", null, _react2.default.createElement(_reactRouter.Link, {
                        to: "/phase/3"
                    }, "GAPS Phase 3")), _react2.default.createElement("li", null, _react2.default.createElement(_reactRouter.Link, {
                        to: "/phase/4"
                    }, "GAPS Phase 4")), _react2.default.createElement("li", null, _react2.default.createElement(_reactRouter.Link, {
                        to: "/phase/5"
                    }, "GAPS Phase 5")), _react2.default.createElement("li", null, _react2.default.createElement(_reactRouter.Link, {
                        to: "/phase/6"
                    }, "GAPS Phase 6")), _react2.default.createElement("li", null, _react2.default.createElement(_reactRouter.Link, {
                        to: "/phase/7"
                    }, "GAPS Phase 7")))), _react2.default.createElement("li", null, _react2.default.createElement(_reactRouter.Link, {
                        to: "/add"
                    }, "Add")))));
                }
            } ]), Navbar;
    ...
    var _createClass = function() {
    ...
    }(), _react = __webpack_require__(5), _react2 = _interopRequireDefault(_react), _AddFoodStore = __webpack_require__(237), _AddFoodStore2 = _interopRequireDefault(_AddFoodStore), _AddFoodActions = __webpack_require__(223), _AddFoodActions2 = _interopRequireDefault(_AddFoodActions), AddFood = function(_React$Component) {
        function AddFood(props) {
            ...
            return _this.state = _AddFoodStore2.default.getState(), _this.onChange = _this.onChange.bind(_this), 
            _this;
        }
        return _inherits(AddFood, _React$Component), _createClass(AddFood, [ {
            key: "componentDidMount",
            value: function() {
            ...
            value: function(event) {
                event.preventDefault();
                var name = this.state.name.trim(), category = this.state.category, phase = this.state.phase;
                name || (_AddFoodActions2.default.invalidName(), this.refs.nameTextField.focus()), 
                category || _AddFoodActions2.default.invalidCategory(), phase || _AddFoodActions2.default.invalidPhase(), 
                name && category && phase && _AddFoodActions2.default.addFood(name, category, phase);
            }
        }, {
            key: "render",
            value: function() {
                return _react2.default.createElement("div", {
                ...
                }, "Add Food"), _react2.default.createElement("div", {
                ...
                }, "Food Name"), _react2.default.createElement("input", {
                    type: "text",
                    className: "form-control",
                    ref: "nameTextField",
                    value: this.state.name,
                    onChange: _AddFoodActions2.default.updateName,
                    autoFocus: !0
                }), _react2.default.createElement("span", {
                    className: "help-block"
                }, this.state.helpBlock)), _react2.default.createElement("div", {
                    className: "form-group " + this.state.categoryValidationState
                }, _react2.default.createElement("label", {
                    className: "control-label"
                }, "Category"), _react2.default.createElement("input", {
                    type: "text",
                    className: "form-control",
                    ref: "nameTextField",
                    value: this.state.category,
                    onChange: _AddFoodActions2.default.updateCategory,
                    autoFocus: !0
                }), _react2.default.createElement("span", {
                    className: "help-block"
                }, this.state.helpBlock)), _react2.default.createElement("div", {
                    ...
                    id: "1",
                    value: "1",
                    checked: "1" === this.state.phase,
                    onChange: _AddFoodActions2.default.updatePhase
                }), _react2.default.createElement("label", {
                    htmlFor: "1"
                }, "GAPS Phase 1")), _react2.default.createElement("div", {
                    className: "radio radio-inline"
                }, _react2.default.createElement("input", {
                    type: "radio",
                    name: "phase",
                    id: "2",
                    value: "2",
                    checked: "2" === this.state.phase,
                    onChange: _AddFoodActions2.default.updatePhase
                }), _react2.default.createElement("label", {
                    htmlFor: "2"
                }, "GAPS Phase 2")), _react2.default.createElement("div", {
                    className: "radio radio-inline"
                }, _react2.default.createElement("input", {
                    type: "radio",
                    name: "phase",
                    id: "3",
                    value: "3",
                    checked: "3" === this.state.phase,
                    onChange: _AddFoodActions2.default.updatePhase
                }), _react2.default.createElement("label", {
                    htmlFor: "3"
                }, "GAPS Phase 3")), _react2.default.createElement("div", {
                    className: "radio radio-inline"
                }, _react2.default.createElement("input", {
                    type: "radio",
                    name: "phase",
                    id: "4",
                    value: "4",
                    checked: "4" === this.state.phase,
                    onChange: _AddFoodActions2.default.updatePhase
                }), _react2.default.createElement("label", {
                    htmlFor: "4"
                }, "GAPS Phase 4")), _react2.default.createElement("div", {
                    className: "radio radio-inline"
                }, _react2.default.createElement("input", {
                    type: "radio",
                    name: "phase",
                    id: "5",
                    value: "5",
                    checked: "5" === this.state.phase,
                    onChange: _AddFoodActions2.default.updatePhase
                }), _react2.default.createElement("label", {
                    htmlFor: "5"
                }, "GAPS Phase 5")), _react2.default.createElement("div", {
                    className: "radio radio-inline"
                }, _react2.default.createElement("input", {
                    type: "radio",
                    name: "phase",
                    id: "6",
                    value: "6",
                    checked: "6" === this.state.phase,
                    onChange: _AddFoodActions2.default.updatePhase
                }), _react2.default.createElement("label", {
                    htmlFor: "6"
                }, "GAPS Phase 6")), _react2.default.createElement("div", {
                    className: "radio radio-inline"
                }, _react2.default.createElement("input", {
                    type: "radio",
                    name: "phase",
                    id: "7",
                    value: "7",
                    checked: "7" === this.state.phase,
                    onChange: _AddFoodActions2.default.updatePhase
                }), _react2.default.createElement("label", {
                    htmlFor: "7"
                }, "GAPS Phase 7"))), _react2.default.createElement("button", {
                    type: "submit",
    ...
    }(), _react = __webpack_require__(5), _react2 = _interopRequireDefault(_react), _Navbar = __webpack_require__(229), _Navbar2 = _interopRequireDefault(_Navbar), _Footer = __webpack_require__(234), _Footer2 = _interopRequireDefault(_Footer), App = function(_React$Component) {
        function App() {
        ...
        return _inherits(App, _React$Component), _createClass(App, [ {
            ...
            value: function() {
                return _react2.default.createElement("div", null, _react2.default.createElement(_Navbar2.default, {
                    history: this.props.history
                }), this.props.children, _react2.default.createElement(_Footer2.default, null));
            }
        } ]), App;
    }(_react2.default.Component);
    exports.default = App;
    ...
    (function($) {
        ...
        }(), _react = __webpack_require__(5), _react2 = _interopRequireDefault(_react), _FoodStore = __webpack_require__(239), _FoodStore2 = _interopRequireDefault(_FoodStore), _FoodActions = __webpack_require__(224), _FoodActions2 = _interopRequireDefault(_FoodActions), Food = function(_React$Component) {
            function Food(props) {
                _classCallCheck(this, Food);
                var _this = _possibleConstructorReturn(this, (Food.__proto__ || Object.getPrototypeOf(Food)).call(this, props));
                return _this.state = _FoodStore2.default.getState(), _this.onChange = _this.onChange.bind(_this), 
                _this;
            }
            return _inherits(Food, _React$Component), _createClass(Food, [ {
                key: "componentDidMount",
                value: function() {
                    _FoodStore2.default.listen(this.onChange), _FoodActions2.default.getFood(this.props.params._id), 
                ...
                key: "componentWillUnmount",
                value: function() {
                    _FoodStore2.default.unlisten(this.onChange), $(document.body).removeClass();
                }
            }, {
                key: "componentDidUpdate",
                value: function(prevProps) {
                    prevProps.params.id !== this.props.params._id && _FoodActions2.default.getFood(this.props.params._id);
                }
            }, {
                key: "onChange",
                value: function(state) {
                ...
                value: function() {
                    return _react2.default.createElement("div", {
                        ...
                        href: "https://upload.wikimedia.org/wikipedia/commons/c/c9/-Insert_image_here-.svg"
                    }, _react2.default.createElement("img", {
                        src: "https://upload.wikimedia.org/wikipedia/commons/c/c9/-Insert_image_here-.svg"
                    }))), _react2.default.createElement("div", {
                        className: "media-body"
                    }, _react2.default.createElement("small", null, "Name:", _react2.default.createElement("strong", null, this.state.name)), _react2.default.createElement("br", null), _react2.default.createElement("small", null, "Category:", _react2.default.createElement("strong", null, this.state.category)), _react2.default.createElement("br", null), _react2.default.createElement("small", null, "Phase:", _react2.default.createElement("strong", null, this.state.phase)), _react2.default.createElement("br", null)));
                }
            } ]), Food;
        }(_react2.default.Component);
    ...
    var _createClass = function() {
    ...
    }(), _react = __webpack_require__(5), _react2 = _interopRequireDefault(_react), _reactRouter = __webpack_require__(44), _underscore = __webpack_require__(111), _FoodListStore = __webpack_require__(238), _FoodListStore2 = _interopRequireDefault(_FoodListStore), _FoodListActions = __webpack_require__(225), _FoodListActions2 = _interopRequireDefault(_FoodListActions), FoodList = function(_React$Component) {
        function FoodList(props) {
            ...
            return _this.state = _FoodListStore2.default.getState(), _this.onChange = _this.onChange.bind(_this), 
            _this;
        }
        return _inherits(FoodList, _React$Component), _createClass(FoodList, [ {
            key: "componentDidMount",
            value: function() {
                _FoodListActions2.default.getFoods(this.props.params), _FoodListStore2.default.listen(this.onChange);
            }
        }, {
            key: "componentWillUnmount",
            value: function() {
            ...
            key: "componentDidUpdate",
            value: function(prevProps) {
                (0, _underscore.isEqual)(prevProps.params, this.props.params) || _FoodListActions2.default.getFoods(this.props.params);
            }
        }, {
            key: "onChange",
            value: function(state) {
            ...
            value: function() {
                var foodList = this.state.foods.map(function(food, index) {
                    return _react2.default.createElement("div", {
                    ...
                    }, index + 1), _react2.default.createElement("div", {
                        ...
                        className: "media-body"
                    }, _react2.default.createElement("small", null, "Name:", _react2.default.createElement("strong", null, food.name)), _react2.default.createElement("br", null), _react2.default.createElement("small", null, "Category:", _react2.default.createElement("strong", null, food.category)), _react2.default.createElement("br", null), _react2.default.createElement("small", null, "Phase:", _react2.default.createElement("strong", null, food.phase)), _react2.default.createElement("br", null))));
                });
                return _react2.default.createElement("div", {
                    className: "container"
                }, _react2.default.createElement("div", {
    ...
    }(), _react = __webpack_require__(5), _react2 = _interopRequireDefault(_react), _FooterStore = (__webpack_require__(44), 
    __webpack_require__(240)), _FooterStore2 = _interopRequireDefault(_FooterStore), _FooterActions = __webpack_require__(226), Footer = (_interopRequireDefault(_FooterActions), 
    function(_React$Component) {
        function Footer(props) {
            _classCallCheck(this, Footer);
            var _this = _possibleConstructorReturn(this, (Footer.__proto__ || Object.getPrototypeOf(Footer)).call(this, props));
            return _this.state = _FooterStore2.default.getState(), _this.onChange = _this.onChange.bind(_this), 
            _this;
        }
        return _inherits(Footer, _React$Component), _createClass(Footer, [ {
            key: "componentDidMount",
            value: function() {
            ...
            key: "render",
            value: function() {
                return _react2.default.createElement("footer", null, _react2.default.createElement("div", {
                    className: "container"
                }, _react2.default.createElement("div", {
                    className: "row"
                }, _react2.default.createElement("div", {
    ...
    }(), _react = __webpack_require__(5), _react2 = _interopRequireDefault(_react), _HomeStore = (__webpack_require__(44), 
    __webpack_require__(241)), _HomeStore2 = _interopRequireDefault(_HomeStore), _HomeActions = __webpack_require__(227), Home = (_interopRequireDefault(_HomeActions), 
    __webpack_require__(111), function(_React$Component) {
        function Home(props) {
            _classCallCheck(this, Home);
            var _this = _possibleConstructorReturn(this, (Home.__proto__ || Object.getPrototypeOf(Home)).call(this, props));
            return _this.state = _HomeStore2.default.getState(), _this.onChange = _this.onChange.bind(_this), 
            _this;
        }
        return _inherits(Home, _React$Component), _createClass(Home, [ {
            key: "componentDidMount",
            value: function() {
            ...
            value: function() {
                ...
                }, _react2.default.createElement("p", null, "This is home"));
            }
        } ]), Home;
    }(_react2.default.Component));
    ...
    var _react = __webpack_require__(5), _react2 = _interopRequireDefault(_react), _reactRouter = __webpack_require__(44), _App = __webpack_require__(231), _App2 = _interopRequireDefault(_App), _Home = __webpack_require__(235), _Home2 = _interopRequireDefault(_Home), _FoodList = __webpack_require__(233), _FoodList2 = _interopRequireDefault(_FoodList), _Food = __webpack_require__(232), _Food2 = _interopRequireDefault(_Food), _AddFood = __webpack_require__(230), _AddFood2 = _interopRequireDefault(_AddFood);
    exports.default = _react2.default.createElement(_reactRouter.Route, {
    ...
    }(), _alt = __webpack_require__(25), _alt2 = _interopRequireDefault(_alt), _AddFoodActions = __webpack_require__(223), _AddFoodActions2 = _interopRequireDefault(_AddFoodActions), AddFoodStore = function() {
        function AddFoodStore() {
            _classCallCheck(this, AddFoodStore), this.bindActions(_AddFoodActions2.default), 
            this.name = "", this.category = "", this.phase = 0, this.helpBlock = "", this.nameValidationState = "", 
            this.categoryValidationState = "", this.phaseValidationState = "";
        }
        return _createClass(AddFoodStore, [ {
            key: "onAddFoodSuccess",
            value: function(successMessage) {
                this.nameValidationState = "has-success", this.helpBlock = successMessage;
            }
        }, {
            key: "onAddFoodFail",
            value: function(errorMessage) {
                this.nameValidationState = "has-error", this.helpBlock = errorMessage;
            }
        }, {
            key: "onUpdateName",
            value: function(event) {
                this.name = event.target.value, this.nameValidationState = "", this.helpBlock = "";
            }
        }, {
            key: "onUpdateCategory",
            value: function(event) {
                this.category = event.target.value, this.categoryValidationState = "";
            }
        }, {
            key: "onUpdatePhase",
            value: function(event) {
                this.phase = event.target.value, this.phaseValidationState = "";
            }
        }, {
            key: "onInvalidName",
            value: function() {
                this.nameValidationState = "has-error", this.helpBlock = "Please enter a Food name.";
            }
        }, {
    ...
    }(), _alt = __webpack_require__(25), _alt2 = _interopRequireDefault(_alt), _toastr = __webpack_require__(69), _toastr2 = _interopRequireDefault(_toastr), _FoodListActions = __webpack_require__(225), _FoodListActions2 = _interopRequireDefault(_FoodListActions), FoodListStore = function() {
        function FoodListStore() {
            _classCallCheck(this, FoodListStore), this.bindActions(_FoodListActions2.default), 
            this.foods = [];
        }
        return _createClass(FoodListStore, [ {
            key: "getFoodsSuccess",
            value: function(data) {
                this.foods = data;
            }
            ...
            key: "getFoodsFail",
            value: function(jqXhr) {
                _toastr2.default.error(jqXhr.responseJSON.message);
            }
        } ]), FoodListStore;
    }();
    ...
    }(), _alt = __webpack_require__(25), _alt2 = _interopRequireDefault(_alt), _toastr = __webpack_require__(69), _toastr2 = _interopRequireDefault(_toastr), _FoodActions = __webpack_require__(224), _FoodActions2 = _interopRequireDefault(_FoodActions), FoodStore = function() {
        function FoodStore() {
            _classCallCheck(this, FoodStore), this.bindActions(_FoodActions2.default), this._id = 0, 
            this.name = "", this.category = 0, this.phase = "";
        }
        return _createClass(FoodStore, [ {
            key: "onGetFoodSuccess",
            value: function(data) {
                assign(this, data);
                var localData = localStorage.getItem("food") ? JSON.parse(localStorage.getItem("food")) : {};
                localData.reports || [];
            }
        }, {
            key: "onGetFoodFail",
    ...
    var _alt = __webpack_require__(25), _alt2 = _interopRequireDefault(_alt), _FooterActions = __webpack_require__(226), _FooterActions2 = _interopRequireDefault(_FooterActions), FooterStore = function FooterStore() {
        _classCallCheck(this, FooterStore), this.bindActions(_FooterActions2.default);
    };
    ...
    }(), _alt = __webpack_require__(25), _alt2 = _interopRequireDefault(_alt), _toastr = __webpack_require__(69), _toastr2 = _interopRequireDefault(_toastr), _HomeActions = __webpack_require__(227), _HomeActions2 = _interopRequireDefault(_HomeActions), HomeStore = function() {
        function HomeStore() {
            _classCallCheck(this, HomeStore), this.bindActions(_HomeActions2.default), this.foods = [];
        }
        return _createClass(HomeStore, [ {
            ...
            value: function(errorMessage) {
                _toastr2.default.error(errorMessage);
            }
        }, {
            key: "onVoteFail",
            value: function(errorMessage) {
    ...
    }(), _alt = __webpack_require__(25), _alt2 = _interopRequireDefault(_alt), _toastr = __webpack_require__(69), _toastr2 = _interopRequireDefault(_toastr), _NavbarActions = __webpack_require__(228), _NavbarActions2 = _interopRequireDefault(_NavbarActions), NavbarStore = function() {
        function NavbarStore() {
            _classCallCheck(this, NavbarStore), this.bindActions(_NavbarActions2.default), this.totalFoods = 0, 
            this.onlineUsers = 0, this.searchQuery = "", this.ajaxAnimationClass = "";
        }
        return _createClass(NavbarStore, [ {
            ...
            key: "onFindFoodFail",
            value: function(payload) {
                payload.searchForm.classList.add("shake"), setTimeout(function() {
    ...
    var _extends = Object.assign || function(target) {
        ...
        return target;
    }, _invariant = __webpack_require__(10), _invariant2 = _interopRequireDefault(_invariant), _Actions = __webpack_require__(26), _ExecutionEnvironment = __webpack_require__(43), _DOMUtils = __webpack_require__(70), _DOMStateStorage = __webpack_require__(112), _createDOMHistory = __webpack_require__(113), _createDOMHistory2 = _interopRequireDefault(_createDOMHistory), _parsePath = __webpack_require__(23), _parsePath2 = _interopRequireDefault(_parsePath);
